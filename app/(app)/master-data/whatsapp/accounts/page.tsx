...
export default async function WhatsAppAccountsPage() {
  ...
  return <main className="flex flex-col gap-6"><WhatsAppAutoRefresh enabled={accounts.some((account) => account.status === "PAIRING")} /><PageHeader title="Akun & Koneksi WhatsApp" description="Hubungkan nomor bisnis dan tentukan satu nomor yang dipakai untuk mengirim." />
