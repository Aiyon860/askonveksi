...
const typeLabels = { MANUAL: "Manual", CAMPAIGN_TEST: "Test campaign", NEXT_ACTION: "Tindak lanjut", REPEAT_ORDER: "Automasi lama", REACTIVATION: "Reminder order", INVOICE_ISSUED: "Invoice terbit", INVOICE_DUE: "Pengingat pembayaran", CAMPAIGN: "Campaign promo" } as const;
